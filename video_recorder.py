...
def toggle_recording():
    ...
    if not recording:
        ...
        audio_data = sd.rec(10 * sd.default.samplerate, samplerate=sd.default.samplerate, channels=2, dtype="int16")
        start_timer()
    else:
        # Stop recording
        recording = False
...
# Set the window icon
image_icon = tk.PhotoImage(file="C:\\Users\\Abdussamad\\OneDrive\\Desktop\\icon.png")
root.iconphoto(True, image_icon)

# Set the logo image
photo = tk.PhotoImage(file="C:\\Users\\Abdussamad\\OneDrive\\Desktop\\image.png")
